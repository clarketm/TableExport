...
;(function (factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['jquery', 'node-safe-filesaver', 'xlsx'], function ($, fs, xlsx) {
            return factory(window, $, fs.saveAs, xlsx.XLSX);
        });
    } else if (typeof exports !== 'undefined') {
        module.exports = factory(window, require('jquery'), require('node-safe-filesaver').saveAs, require('xlsx').XLSX);
    } else {
