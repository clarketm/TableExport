...
; (function (root, factory) {
    ...
    TableExport.prototype = {
        ...
        defaults: {
            ...
            formats: ['xlsx', 'csv', 'txt', 'doc'],            // (String[]), filetype(s) for the export, (default: ['xlsx', 'csv', 'txt'])
        ...
        formatConfig: {
            ...
            /**
             * DOC (Microsoft Office Word) file extension configuration
             * @memberof TableExport.prototype
             */
            doc: {
                defaultClass: 'doc',
                buttonContent: 'Export to Microsoft Office Word',
                separator: '  ',
        ...
        exporters: {
            build: function (context, key) {
                ...
                var dataURI = null;
                if (key !== "doc") {
                    dataURI = _nodesArray(context.rows).map(function (val, ir) {
                    ...
                    // Remove the buttons
                    context.el.querySelectorAll('button').forEach(e => e.parentNode.removeChild(e));
                    dataURI = context.el.outerHTML
                }
