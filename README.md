# [TableExport](https://www.travismclarke.com/tableexport) &nbsp; [![Build Status](https://travis-ci.org/clarketm/TableExport.svg?branch=develop)](https://travis-ci.org/clarketm/TableExport)
